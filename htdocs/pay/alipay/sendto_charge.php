...
//服务器异步通知页面路径
$notify_url = "http://".$_SERVER['HTTP_HOST']."/pay/alipay/notify_charge.php";
//需http://格式的完整路径，不允许加?id=123这类自定义参数

//页面跳转同步通知页面路径
$call_back_url = "http://".$_SERVER['HTTP_HOST']."/pay/alipay/call_back_charge.php";
//需http://格式的完整路径，不允许加?id=123这类自定义参数
...
//商户订单号
$out_trade_no = time().$OrderID;
//商户网站订单系统中唯一订单号，必填

//订单名称
$subject = "(会员)在线充值，充值编号:".$OrderID;
//必填

//付款金额
$total_fee = strval(floatval($rsCharge["Amount"]));
//必填
