...
define("JS_API_CALL_URL","http://".$_SERVER['HTTP_HOST']."/pay/wxpay2/sendto_pintuan.php?UsersID=".$UsersID."_".$OrderID);
			...
			WeixinJSBridge.invoke(
				...
				function(res){
					...
					if(res.err_msg=='get_brand_wcpay_request:ok'){
						window.location.href = 'http://<?php echo $_SERVER['HTTP_HOST'];?>/pay/wxpay2/pintuan_url.php?OrderID=<?php echo $OrderID;?>';
					}
				}
			);
		}
