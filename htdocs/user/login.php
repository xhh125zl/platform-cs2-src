...
<div class="w">
    ...
    <form id="form1" name="form1" method="post">
    	<input type="text" name="Account" id="Account" value="" maxlength="11" class="login_x" placeholder="登录用户名" notnull="">
        ...
        <input name="提交" type="button" class="login_sub" value="立即登录">
            <div class="login_t">
               <span class="l"><a href="#">忘记密码？</a></span>
               <span class="r"><a href="#">立即注册</a></span>
        </div>
    </form>
    </div>
</div>
