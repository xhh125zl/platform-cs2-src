...
<div class="w">
    ...
    <div class="shop_list">
    	<ul>
        	<li>
            	<a><span class="l">店铺头像<span><img style="border-radius:17px" src='<?php echo IMG_SERVER . $config['ShopLogo'];?>' width=35 height=35 /></span></span><span class="r"><i class="fa  fa-angle-right fa-2x" aria-hidden="true"></i></span></a>
            </li>
            <li>
