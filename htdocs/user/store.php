...
<div class="w">
    ...
    <div class="plate_x">
        <ul class="list_x">
            <li>
                <a href='?act=order_delivered'><img src="../static/user/images/ico_07.png" width="25" height="25"><p>订单管理</p></a>
            </li>
            <li>
            ...
            <li>
                <a href='?act=distribute_oneLevel'><img src="../static/user/images/ico_01.png" width="25" height="25"><p>分销管理</p></a>
            </li>
            <li>
