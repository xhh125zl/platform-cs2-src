        ...
        <div class="box">
            <div class="system-message">
                <?php if(isset($output['message'])) {?>
                    <h1>Oh Yeah,操作成功！</h1>
                    <p class="success"><?php echo($output['message']); ?></p>
                  <?php }else { ?>
            ...
            <p class="jump">等待 <b id="wait" style="color:#f00;"><?php echo($output['waitSecond']); ?></b> 秒后页面将自动 <a id="href" href="<?php echo($output['jumpUrl']); ?>">跳转</a> </p>
            <footer>©2016</footer>
        </div>
