...
<div id="iframe_page">
	<div class="iframe_content">
		...
		<div id="products" class="r_con_wrap">
			<form class="r_con_form" method="post" action="<?php echo url('pc_diy/block_edit');?>">
				<div class="rows">
					<label>板块名称</label>
					<span class="input">
					<input type="text" name="web_name" value="<?php echo $output['web_array']['web_name']?>" class="form_input" size="35" maxlength="100"/>
				...
				<div class="rows">
					<label>色彩风格</label>
					<span class="input">
					<div class="color_box"><input type="text" name="style_name" value="<?php echo $output['web_array']['style_name']?>" readonly="readonly" style="background:<?php echo $output['web_array']['style_name']?>"/></div>
					</span>
					<div class="clear"></div>
				</div>
				<div class="rows">
					<label>排序</label>
					<span class="input">
					<input type="text" name="web_sort" value="<?php echo $output['web_array']['web_sort']?>" class="form_input" size="5" maxlength="10" />
				...
				<div class="rows">
					<label>显示</label>
					<span class="input">
					<label><input type="radio" value="1" <?php if($output['web_array']['web_show'] == 1){?> checked="checked"<?php }?> name="web_show"/>是</label>&nbsp;&nbsp;
					<label><input type="radio" value="0" <?php if($output['web_array']['web_show'] == 0){?> checked="checked"<?php }?> name="web_show"/>否</label>
					</span>
					<div class="clear"></div>
				</div>
				<div class="rows">
