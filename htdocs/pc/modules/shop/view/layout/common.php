...
<div class="top_bg">
	<div class="top">
		...
		<div class="top_left"><em>您好，欢迎来到<a href="<?php echo url('index/index');?>"><?php echo $output['shopConfig']['shopname'];?></a>网上商城</em><a href="<?php echo url('public/login');?>" class="login">请登录</a><a href="<?php echo url('public/register',array('UsersID'=>$output['UsersID']));?>" class="sign">免费注册</a>&nbsp;&nbsp;<a href="<?php echo url('distribute/distribute_invite');?>" style="color:#d30015;">邀请返利</a></div>
	    <?php }else {?>
