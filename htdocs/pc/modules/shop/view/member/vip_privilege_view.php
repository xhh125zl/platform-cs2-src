...
<div class="product-intro">
	<div class="wzw-wrapper" style="width:1200px; margin:0 auto;">
		<div class="nch-article-con">
		    <h1><?php echo $output['info']['Benefits_Title'];?></h1>
			<h2><?php echo $output['info']['Benefits_StartTime'].'~'.$output['info']['Benefits_EndTime'];?></h2>
		    <div class="default">
			    <p><?php echo $output['info']['Benefits_Description'];?></p>
		    </div>
		</div>
	</div>
</div>