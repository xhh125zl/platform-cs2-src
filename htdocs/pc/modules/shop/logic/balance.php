...
class balance{
	...
	public function add_sales($orderid) {
		...
		$rs = model()->query('select SUM(b.Record_Money) as bonus from shop_distribute_account_record as b LEFT JOIN shop_distribute_record as r ON b.Ds_Record_ID=r.Record_ID where r.Order_ID=' . $orderid . ' limit 0,1', 'FIND');
