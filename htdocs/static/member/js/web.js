var web_obj={
	...
	column_edit_init:function(){
		$('#column_form input[name=PageType]').click(function(){
		...
		$('#column_form .btn_select_url').click(function(){
			global_obj.create_layer('选择链接', '/member/material/sysurl.php?dialog=1&input=web_common',1000,500);
		});
	...
	article_edit_init:function(){
		
		$('#article_form .btn_select_url').click(function(){
			global_obj.create_layer('选择链接', '/member/material/sysurl.php?dialog=1&input=web_common',1000,500);
		});
