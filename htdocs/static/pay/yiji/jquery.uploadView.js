...
(function($){
	$.fn.uploadView = function(options){
		...
		var handleFileSelect = function(obj, _w, _h, _type, _size, _callback){
            ...
            var id = $(obj[0]).parent().parent().parent().find(".imgpath").attr("id");
						  var img = '<div class="photoview"><img title="点击删除图片" src="' + tmpSrc + '" /><span class="deleted">删除</span></div>';
						  $(obj[0]).parent().hide();
						  $(obj[0]).parent().parent().parent().find(".baseImg").val(tmpSrc);
