...
class Commission {
		...
		*/
		function handout_dis_commission($UsersID,$OwnerID,$BuyerID,$dis_self_bonus,$products,$qty){
			...
			$nobility = $products['Products_Price']*$qty*$products['Products_Profit']*$nobi_ratio*0.01*0.01*($products['platForm_Income_Reward']/100);
			//爵位奖励    $products['platForm_Income_Reward'] => 平台利润的发放比例
