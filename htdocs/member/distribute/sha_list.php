      ...
      <table width="100%" align="center" border="0" cellpadding="5" cellspacing="0" class="r_con_table">
        <thead>
          <tr>
			...
			<td width="10%" nowrap="nowrap">股东ID</td>
			<td width="30%" nowrap="nowrap">微信昵称</td>
			<td width="30%" nowrap="nowrap">真实姓名</td>
             <td width="20%" nowrap="nowrap">分红</td>
          </tr>
        </thead>		
        <tbody>	
			<?php
		  $condition .= " and Enable_Agent = 1 order by User_ID desc";
		  $DB->getPage("distribute_account","User_ID,Account_ID,Real_Name,Enable_Agent",$condition,$psize);		  
		  /*获取订单列表牵扯到的分销商*/
		  $sha_list = array();		  
		  $userid = array();
		  $accid = array();
