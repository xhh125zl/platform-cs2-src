...
$rsConfig = Dis_Config::find($Users_ID);
...
<div id="iframe_page">
  <div class="iframe_content">
    ...
    <!-- level filter begin -->
    	<?php
			$level = array(1=>'一',2=>'二',3=>'三',4=>'四',5=>'五',6=>'六',7=>'七',
			          8=>'八',9=>'九');
		?>
        <div class="btn-group" id="level_filter">
           <?php for($i=1;$i<=$level_config;$i++):?>  
  			<a  class="btn btn-default <?=($level == $i)?'cur':''?>" href="?User_ID=<?=$User_ID?>&level=<?=$i?>"><?=$level[$i]?>级分销商</a>
  		   <?php endfor;?>   
		</div>
