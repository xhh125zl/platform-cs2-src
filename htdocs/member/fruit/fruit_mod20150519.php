...
if($_POST){
	...
	$Data=array(
		...
		"Fruit_Description"=>$_POST['Description'],
		"Fruit_Status"=>2
	);
...
KindEditor.ready(function(K) {
	editor = K.create('textarea[name="Fruit_Description"]', {
		themeType : 'simple',
		filterMode : false,
		uploadJson : '/member/upload_json.php?TableField=fruit',
    ...
    <div id="wheel" class="r_con_wrap">
      <form class="r_con_form" id="wheel_form">
        ...
        <div class="rows">
          <label>活动时间</label>
          <span class="input">
          <input name="Time" type="text" value="<?php echo date("Y-m-d H:i:s",$rsFruit["Fruit_StartTime"])." - ".date("Y-m-d H:i:s",$rsFruit["Fruit_EndTime"]) ?>" class="form_input" size="42" readonly="readonly" notnull />
          <font class="fc_red">*</font></span>
          <div class="clear"></div>
        </div>
        <div class="rows">
