...
$rsAttr = $DB->GetRs("shop_attribute","*","where Users_ID='".$_SESSION["Users_ID"]."' and Attr_ID=".$AttrID);

$group_list = get_attr_groups($rsAttr['Type_ID'],$_SESSION["Users_ID"]);
            ...
            <div class="opt_item" id="product_type_html">
              ...
              <select name="Type_ID" id="Type_ID" style="width:180px;" notnull>
               ...
               <?php foreach($shop_product_type_list as $key=>$product_type):?>
                	...
                	<option value="<?=$product_type['Type_ID']?>" <?=($key == $rsAttr['Attr_Type'])?'selected':''?>><?=$product_type['Type_Name']?></option>
