...
if ($_POST) 
{
  ...
  if (!is_numeric($_POST['noBi_Reward']) || !is_numeric($_POST['area_Proxy_Reward']) || !is_numeric($_POST['sha_Reward']) || !is_numeric($_POST['commission_Reward']) || ($_POST['noBi_Reward']+$_POST['area_Proxy_Reward']+$_POST['commission_Reward']+$_POST['sha_Reward']) > 100 || ($_POST['noBi_Reward']+$_POST['area_Proxy_Reward']+$_POST['commission_Reward']+$_POST['sha_Reward']) < 0 ) 
  {
