        ...
        <table border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td width="50%" valign="top"><h1><strong>订单确认</strong><span class="tips">（关闭后下订单可直接付款，无需经过卖家确认）</span></h1>
              <div class="input">
                <input type="checkbox" name="CheckOrder" value="1"<?php echo empty($rsConfig["CheckOrder"])?"":" checked"; ?> /> <span class="tips">关闭(只针对在线付款有效)</span>
              </div></td>
              <td width="50%" valign="top"><h1><strong>评论审核</strong><span class="tips">（关闭后客户评论可不经过审核直接显示在前台页面）</span></h1>
              <div class="input">
                <input type="checkbox" name="CommitCheck" value="1"<?php echo empty($rsConfig["Commit_Check"])?"":" checked"; ?> /> <span class="tips">关闭</span>
              </div>
              </td>
          </tr>
		  <tr>
          ...
          <tr style="display:none">
            <td width="50%" valign="top">
              <h1><strong>非分销商分享获取积分</strong>
                <input type="checkbox" name="MemberShare" value="1"<?php echo empty($rsConfig["Member_Share"])?"":" checked"; ?> />
                <span class="tips">开启</span></h1>
              <input type="text" class="input" name="MemberShareScore" style="width:50px" value="<?php echo $rsConfig["Member_ShareScore"] ?>" />
            </td>
            <td width="50%" valign="top">
				<h1><strong>分销商分享获取积分</strong>
                <input type="checkbox" name="DistributeShare" value="1"<?php echo empty($rsConfig["Distribute_Share"])?"":" checked"; ?> />
                <span class="tips">开启</span></h1>
              <input type="text" class="input" name="DistributeShareScore" style="width:50px" value="<?php echo $rsConfig["Distribute_ShareScore"] ?>" />
