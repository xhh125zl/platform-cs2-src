...
if($_POST){
	...
	if (!is_numeric($_POST['nobi_ratio']) || !is_numeric($_POST['area_Proxy_Reward']) || !is_numeric($_POST['sha_Reward']) || !is_numeric($_POST['commission_ratio']) || ($_POST['nobi_ratio']+$_POST['area_Proxy_Reward']+$_POST['commission_ratio']+$_POST['sha_Reward']) > 100 || ($_POST['nobi_ratio']+$_POST['area_Proxy_Reward']+$_POST['commission_ratio']+$_POST['sha_Reward']) < 0 ) 
    {
  ...
  <div class="iframe_content">
    ...
    <div id="products" class="r_con_wrap">
      ...
      <form class="r_con_form" id="product_edit_form" method="post" action="products_edit.php">
        ...
        <div class="custom"><a href="javascript:void(0);" class="show_commision">自定义商品佣金</a><a href="javascript:void(0);" class="close_commision">返回使用默认值</a></div>
