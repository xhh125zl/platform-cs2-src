...
$item = $DB->GetRs("shop_shipping_print_template","*","where usersid='".$_SESSION["Users_ID"]."' and itemid=".$itemid);
if(!$item){
...
$thumb_height = $item["height"]*3.8-20000;
$thumb_top = $item["offset_top"]*3.8;
$thumb_left = $item["offset_left"]*3.8-20000;
