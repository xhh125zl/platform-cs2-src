    ...
    <div id="bizs" class="r_con_wrap">
      ...
      <form class="r_con_form" method="post" action="?" id="group_edit">
        ...
        <div class="rows">
          ...
          <option value="<?php echo $GroupID;?>"<?php echo $rsBiz["Group_ID"] == $GroupID ? ' selected' : ''?>><?php echo $v["Group_Name"];?></option>
          <?php }?>
          </select>
          <font class="fc_red">*</font></span>
          <div class="clear"></div>
        ...
        <div class="rows">
          <label>财务结算类型</label>
          <span class="input">
              <input type="radio" name="FinanceType" value="0" id="FinanceType_0" onClick="$('#FinanceRate').show();"<?php echo $rsBiz["Finance_Type"]==0 ? ' checked' : '';?> /><label for="FinanceType_0"> 按交易额比例</label>&nbsp;&nbsp;<input type="radio" name="FinanceType" value="1" id="FinanceType_1" onClick="$('#FinanceRate').hide();"<?php echo $rsBiz["Finance_Type"]==1 ? ' checked' : '';?> /><label for="FinanceType_1"> 具体产品设置</label><br /><span class="tips">注：若按交易额比例，则网站提成为：产品售价*比例%，网站提成包含网站应得和佣金发放两项</span>
          </span>
          <div class="clear"></div>
        </div>
        <div class="rows" id="FinanceRate"<?php echo $rsBiz["Finance_Type"]==1 ? ' style="display:none"' : '';?>>
          <label>网站提成</label>
          <span class="input">
          <input type="text" name="FinanceRate" value="<?php echo $rsBiz["Finance_Rate"];?>" class="form_input" size="10" /> %
          </span>
          <div class="clear"></div>
        </div>
        ...
        <div class="rows" id="PaymenteRate">
          <label>结算比例</label>
          <span class="input">
          <input type="text" name="PaymenteRate" value="<?php echo $rsBiz["PaymenteRate"];?>" class="form_input" size="10" /> %
          <span class="tips">注：商家财务结算时,按照结算比例款项一部分转向商家指定的卡号,剩下的部分转入商家绑定的前台会员的余额中。</span>
          </span>
          <div class="clear"></div>
        </div>
