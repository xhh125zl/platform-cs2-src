...
<div id="iframe_page">
  <div class="iframe_content">
    ...
    <div class="r_con_wrap">
      ...
      <div class="b10"></div>
      <a href="announce_add.php" style="display:block; width:80px; height:26px; line-height:26px; text-align:center; border-radius:5px; background:#3AA0EB; color:#FFF; font-size:12px;margin: 10px 0;">添加公告</a>
      <div class="b10"></div>
      <table border="0" cellpadding="5" cellspacing="0" class="r_con_table">
		...
		?>
          <tr>
            ...
            <td class="last" nowrap="nowrap"><a href="announce_edit.php?ID=<?php echo $t["Announce_ID"];?>"><img src="/static/admin/images/ico/mod.gif" align="absmiddle" alt="修改" title="修改" /></a>&nbsp;<a href="?action=Del&ID=<?php echo $t["Announce_ID"]; ?>" title="删除" onClick="if(!confirm('删除后不可恢复，继续吗？')){return false};"><img src="/static/admin/images/ico/del.gif" align="absmiddle" alt="删除" title="删除" /></a></td>
          </tr>
