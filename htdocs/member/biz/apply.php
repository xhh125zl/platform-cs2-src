      ...
      <table width="100%" align="center" border="0" cellpadding="5" cellspacing="0" class="r_con_table">
        <thead>
          <tr>
            ...
            <td width="16%" nowrap="nowrap">企业名称</td>
            <td width="10%" nowrap="nowrap">行业类别</td>
		...
		?>
          ...
          <tr>
            ...
            <td><?php echo $rsBiz["Category_ID"] ?></td>
            ...
            <td class="last" nowrap="nowrap"><a href="?action=read&itemid=<?php echo $rsBiz["ItemID"] ?>">[处理]</a> <a href="?action=del&itemid=<?php echo $rsBiz["ItemID"] ?>" onClick="if(!confirm('删除后不可恢复，继续吗？')){return false};">[删除]</a></td>
          </tr>
          <?php }?>
        </tbody>
      </table>
