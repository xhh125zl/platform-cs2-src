<?php
$Dwidth = array('640','264','264','264','370','640','200','110','200','110');
$DHeight = array('360','108','108','108','334','150','160','160','160','160');
      ...
      <div class="m_lefter">
	   <script type="text/javascript">
        ...
        <div class="box">
            ...
            <div class="web_skin_index_list r_img" rel="edit-t05">
                <div class="img"></div>
            </div>
            <div class="clear"></div>
        </div>
        ...
        <div class="box">
            <div class="i5">
                <div class="web_skin_index_list pic" rel="edit-t07">
                    <div class="img"></div>
                </div>
                <div class="web_skin_index_list link padding" rel="edit-t08">
                    <div class="img"></div>
                </div>
            </div>
            <div class="i6">
                <div class="web_skin_index_list pic padding" rel="edit-t09">
                    <div class="img"></div>
                </div>
                <div class="web_skin_index_list link" rel="edit-t10">
                    <div class="img"></div>
                </div>
            </div>
        </div>
