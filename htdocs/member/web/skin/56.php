<?php
$Dwidth = array('640','301','301','301','301','301','301','301','301');
$DHeight = array('350','127','127','127','127','127','127','127','127');
...
<div id="web_skin_index">
    ...
    <div class="web_warp">
    	<div class="item">
        	<div class="section1 web_skin_index_list" rel="edit-t02"><div class="img"></div></div>
            <div class="section2 web_skin_index_list" rel="edit-t03"><div class="img"></div></div>
            <div class="clear"></div>
        </div>
        <div class="item">
        	<div class="section1 web_skin_index_list" rel="edit-t04"><div class="img"></div></div>
            <div class="section2 web_skin_index_list" rel="edit-t05"><div class="img"></div></div>
            <div class="clear"></div>
        </div>
        <div class="item">
        	<div class="section1 web_skin_index_list" rel="edit-t06"><div class="img"></div></div>
            <div class="section2 web_skin_index_list" rel="edit-t07"><div class="img"></div></div>
            <div class="clear"></div>
        </div>
        <div class="item">
        	<div class="section1 web_skin_index_list" rel="edit-t08"><div class="img"></div></div>
            <div class="section2 web_skin_index_list" rel="edit-t09"><div class="img"></div></div>
            <div class="clear"></div>
        </div>
    </div>
</div>
