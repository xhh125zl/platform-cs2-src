...
<div id="iframe_page">
  <div class="iframe_content">
    ...
    <div id="home" class="r_con_wrap">
      <div class="m_lefter"><script language="javascript">
        ...
        <ul id="skin_index_menu">
          <li>
            <div class="bg"></div>
            <a href="column/6698/">关于我们</a> </li>
          <li>
            <div class="bg"></div>
            <a href="albums/">作品展示</a> </li>
          <li>
            <div class="bg"></div>
            <a href="column/6700/">新闻</a> </li>
          <li>
            <div class="bg"></div>
            <a href="column/7890/">微喜帖</a> </li>
          <li>
            <div class="bg"></div>
            <a href="tuan/">团购</a> </li>
          <li>
            <div class="bg"></div>
            <a href="user/">会员卡</a> </li>
          <li>
            <div class="bg"></div>
            <a href="turntable/">抽奖活动</a> </li>
          <li>
            <div class="bg"></div>
            <a href="column/6701/">联系我们</a> </li>
        </ul>
      </div>
      <div class="m_righter">
        <form id="home_form">
