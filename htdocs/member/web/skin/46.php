<?php
$Dwidth = array('640','420','210','0','0','0','210','420','0','0','0');
$DHeight = array('320','210','210','0','0','0','210','210','0','0','0');
...
<body>
<!--[if lte IE 9]><script type='text/javascript' src='http://static.ptweixin.com/js/plugin/jquery/jquery.watermark-1.3.js'></script>
<![endif]-->
	   ...
	   <script language="javascript">
        ...
        <div id="web_skin_index">
          <div class="list">
		   ...
		   <div class="web_skin_index_list i2" rel="edit-t09">
			<div class="text"></div>
		   </div>
		   <div class="web_skin_index_list i3" rel="edit-t10">
			<div class="text"></div>
		   </div>
		   <div class="web_skin_index_list i4" rel="edit-t11">
			<div class="text"></div>
		   </div>
	     </div>
        </div>
            ...
            <div class="item">
              <div class="rows">
                <div class="b_l"> <strong>图片(1)</strong><span class="tips">大图建议尺寸：
                  <label></label>
                  px</span><a href="#web_home_img_del" value="0"><img src="http://static.ptweixin.com/member/images/ico/del.gif" align="absmiddle" /></a><br />
            ...
            <div class="item">
              <div class="rows">
                <div class="b_l"> <strong>图片(2)</strong><span class="tips">大图建议尺寸：
                  <label></label>
                  px</span><a href="#web_home_img_del" value="1"><img src="http://static.ptweixin.com/member/images/ico/del.gif" align="absmiddle" /></a><br />
                  <div class="blank6"></div>
                  <input type="hidden" name="Title[]" value="" />
                  <div>
            ...
            <div class="item">
              <div class="rows">
                <div class="b_l"> <strong>图片(3)</strong><span class="tips">大图建议尺寸：
                  <label></label>
                  px</span><a href="#web_home_img_del" value="2"><img src="http://static.ptweixin.com/member/images/ico/del.gif" align="absmiddle" /></a><br />
                  <div class="blank6"></div>
                  <input type="hidden" name="Title[]" value="" />
                  <div>
            ...
            <div class="item">
              <div class="rows">
                <div class="b_l"> <strong>图片(4)</strong><span class="tips">大图建议尺寸：
                  <label></label>
                  px</span><a href="#web_home_img_del" value="3"><img src="http://static.ptweixin.com/member/images/ico/del.gif" align="absmiddle" /></a><br />
                  <div class="blank6"></div>
                  <input type="hidden" name="Title[]" value="" />
                  <div>
            ...
            <div class="item">
              <div class="rows">
                <div class="b_l"> <strong>图片(5)</strong><span class="tips">大图建议尺寸：
                  <label></label>
                  px</span><a href="#web_home_img_del" value="4"><img src="http://static.ptweixin.com/member/images/ico/del.gif" align="absmiddle" /></a><br />
                  <div class="blank6"></div>
                  <input type="hidden" name="Title[]" value="" />
                  <div>
