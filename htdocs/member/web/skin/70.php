<?php
$Dwidth = array('640','120','120','120','120','120','120','120','120');
$DHeight = array('350','120','120','120','120','120','120','120','120');
    ...
    <div id="home" class="r_con_wrap">     
     ...
     <?php }?>
	    <div class="web_wrap">
            ...
            <div class="web_skin_index_list items fl mar_r" rel="edit-t06">
                <div class="img"></div>
                <div class="text"></div>
            </div>
