...
$json=$DB->GetRs("wechat_material","*","where Users_ID='".$_SESSION["Users_ID"]."' and Material_Table='votes' and Material_TableID=0 and Material_Display=0");
if(empty($json)){
	$Material=array(
		"Title"=>"微投票",
		"ImgPath"=>"/static/api/images/cover_img/votes.jpg",
		"TextContents"=>"",
		"Url"=>"/api/".$_SESSION["Users_ID"]."/votes/"
	);
	$Data=array(
...
$rsKeyword=$DB->GetRs("wechat_keyword_reply","*","where Users_ID='".$_SESSION["Users_ID"]."' and Reply_Table='votes' and Reply_TableID=0 and Reply_Display=0");
if(empty($rsKeyword)){
...
if($_POST)
{
	...
	$Set=$DB->Set("wechat_keyword_reply",$Data,"where Users_ID='".$_SESSION["Users_ID"]."' and Reply_Table='votes' and Reply_TableID=0 and Reply_Display=0");
	$flag=$flag&&$Set;
	$Material=array(
		"Title"=>$_POST["Title"],
	...
	$Set=$DB->Set("wechat_material",$Data,"where Users_ID='".$_SESSION["Users_ID"]."' and Material_Table='votes' and Material_TableID=0 and Material_Display=0");
	$flag=$flag&&$Set;
	if($flag){
		mysql_query("commit");
		$Data=array(
  ...
  <div class="iframe_content">
    ...
    <div class="r_nav">
      <ul>
        ...
        <li class=""><a href="votemanage.php">投票管理</a></li>
      </ul>
    </div>
            ...
            <td><h1><strong>触发信息设置</strong></h1>
              <div class="reply_msg">
                ...
                <div class="m_right"> <span class="fc_red">*</span> 图文消息封面<span class="tips">（大图尺寸建议：640*360px）</span><br />
                  ...
                  <br />
                  <div class="img" id="ImgDetail"><img src="<?php echo empty($rsMaterial["ImgPath"])?"/static/api/images/cover_img/votes.jpg":$rsMaterial["ImgPath"]; ?>" width="640" height="360"></div>
                </div>
                <div class="clear"></div>
              </div>
