    ...
    <div id="games" class="r_con_wrap">
      ...
      <form id="games_form" class="r_con_form">
        ...
        <div class="rows">
          <label>简短介绍</label>
          <span class="input">
          <textarea name="ReplyBriefDescription" class="textarea"><?php echo !empty($Material_Json["TextContents"]) ? $Material_Json["TextContents"] : '按照图片提示，把碎片拼接成完整';?></textarea>
            ...
            <span class="input">
                <span class="upload_file">
                    <div>
                        ...
                        <div class="tips">图片尺寸建议：390*390px</div>
                        <div class="clear"></div>
                    </div>
		...
		<div class="rows">
			<label>游戏规则</label>
			<span class="input"><textarea class="ckeditor" name="Rules" style="width:600px; height:300px;"><?php echo $games["Games_Rules"] ? $games["Games_Rules"] : '按照图片提示，把碎片拼接成完整';?></textarea></span>
			<div class="clear"></div>
		</div>
		<div class="rows">
			<label></label>
