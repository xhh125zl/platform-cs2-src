    ...
    <div id="games" class="r_con_wrap">
      ...
      <form id="games_form" class="r_con_form">
        ...
        <div class="rows">
          <label>简短介绍</label>
          <span class="input">
          <textarea name="ReplyBriefDescription" class="textarea">60秒以内配对相同的萌娃图片</textarea>
		...
		<div class="rows">
			<label>游戏规则</label>
			<span class="input"><textarea class="ckeditor" name="Rules" style="width:600px; height:300px;">60秒以内配对相同的萌娃图片</textarea></span>
			<div class="clear"></div>
		</div>
		<div class="rows">
			<label></label>
