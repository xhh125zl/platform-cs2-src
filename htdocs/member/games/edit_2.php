    ...
    <div id="games" class="r_con_wrap">
      ...
      <form id="games_form" class="r_con_form">
        ...
        <div class="rows">
          <label>简短介绍</label>
          <span class="input">
          <textarea name="ReplyBriefDescription" class="textarea"><?php echo !empty($Material_Json["TextContents"]) ? $Material_Json["TextContents"] : '在直线下面点击宝宝们，不能让他们掉了';?></textarea>
		...
		<div class="rows">
			<label>游戏规则</label>
			<span class="input"><textarea class="ckeditor" name="Rules" style="width:600px; height:300px;"><?php echo $games["Games_Rules"] ? $games["Games_Rules"] : '在直线下面点击宝宝们，不能让他们掉了！';?></textarea></span>
			<div class="clear"></div>
		</div>
		<div class="rows">
			<label></label>
