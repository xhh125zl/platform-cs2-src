    ...
    <script language="javascript">$(document).ready(games_obj.games_edit_init);</script>
      ...
      <form id="games_form" class="r_con_form">
        ...
        <div class="rows">
          <label>简短介绍</label>
          <span class="input">
          <textarea name="ReplyBriefDescription" class="textarea">点击最下面的小苹果开始，20秒内看你能吃掉多少个小苹果！</textarea>
        ...
        <div class="rows">
            <label>游戏时长</label>
            <span class="input"><input type="text" class="form_input" name="Property[time]" value="20" size="5" notnull /><span class="tips">秒</span> <font class="fc_red">*</font> <span class="tips">游戏的总时间，建议设置为20</span></span>
            <div class="clear"></div>
        </div>
        <div class="rows">
            <label>游戏动作名称</label>
            <span class="input"><input type="text" class="form_input" name="Property[dongzuo]" value="吃" size="5" notnull /> <font class="fc_red">*</font> <span class="tips">如：拆</span></span>
            <div class="clear"></div>
        </div>
        <div class="rows">
            <label>游戏计量单位</label>
            <span class="input"><input type="text" class="form_input" name="Property[unit]" value="个" size="5" notnull /> <font class="fc_red">*</font> <span class="tips">如：个</span></span>
            <div class="clear"></div>
        </div>
        <div class="rows">
            <label>游戏内容名称</label>
            <span class="input"><input type="text" class="form_input" name="Property[name]" value="小苹果" size="5" notnull /> <font class="fc_red">*</font> <span class="tips">如：红包，与游戏动作名称和游戏计量单位相组合，那么游戏则变成了XX秒内拆XX个红包</span></span>
            <div class="clear"></div>
        </div>
        <div class="rows">
        ...
        <input type="hidden" name="Property[img]" value="/static/api/games/images/apple.png" />
        <input type="hidden" name="Property[bgimg]" value="" />
        <div class="rows">
			<label>排序优先级</label>
		...
		<div class="rows">
			<label>游戏规则</label>
			<span class="input"><textarea class="ckeditor" name="Rules" style="width:600px; height:300px;">点击最下面的小苹果开始，20秒内看你能吃掉多少个小苹果，点错游戏即结束！</textarea></span>
			<div class="clear"></div>
		</div>
		<div class="rows">
			<label></label>
