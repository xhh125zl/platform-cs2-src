  ...
  <div class="iframe_content">
    ...
    <div id="games" class="r_con_wrap">
      ...
      <form id="games_form" class="r_con_form">
        ...
        <input type="hidden" name="Property[img8]" value="<?php echo !empty($JSON["img8"]) ? $JSON["img8"] : '';?>" />
        <input type="hidden" name="Property[img16]" value="<?php echo !empty($JSON["img16"]) ? $JSON["img16"] : '';?>" />
        <input type="hidden" name="Property[img32]" value="<?php echo !empty($JSON["img32"]) ? $JSON["img32"] : '';?>" />
        <input type="hidden" name="Property[img64]" value="<?php echo !empty($JSON["img64"]) ? $JSON["img64"] : '';?>" />
        <input type="hidden" name="Property[img128]" value="<?php echo !empty($JSON["img128"]) ? $JSON["img128"] : '';?>" />
        <input type="hidden" name="Property[img256]" value="<?php echo !empty($JSON["img256"]) ? $JSON["img256"] : '';?>" />
        <input type="hidden" name="Property[img512]" value="<?php echo !empty($JSON["img512"]) ? $JSON["img512"] : '';?>" />
        <input type="hidden" name="Property[img1024]" value="<?php echo !empty($JSON["img1024"]) ? $JSON["img1024"] : '';?>" />
        <input type="hidden" name="Property[img2048]" value="<?php echo !empty($JSON["img2048"]) ? $JSON["img2048"] : '';?>" />
        <input type="hidden" name="Property[img4096]" value="<?php echo !empty($JSON["img4096"]) ? $JSON["img4096"] : '';?>" />
        <input type="hidden" name="Property[img8192]" value="<?php echo !empty($JSON["img8192"]) ? $JSON["img8192"] : '';?>" />
