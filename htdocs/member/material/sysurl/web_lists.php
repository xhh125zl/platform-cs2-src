      <table border="0" cellpadding="5" cellspacing="0" class="r_con_table">
        ...
        <tbody>
          ...
          <?php
				$list_column = array();
				$i = 0;
				$DB->get("web_article","*","where Users_ID='".$_SESSION["Users_ID"]."' order by Article_ID asc");
          ...
          <tr>
            ...
            <td nowrap="nowrap" class="left last">
            	http://<?php echo $_SERVER["HTTP_HOST"] ?>/api/<?php echo $_SESSION["Users_ID"] ?>/web/article/<?php echo $v["Article_ID"];?>/
            </td>
          </tr>
          <?php
		  		}
