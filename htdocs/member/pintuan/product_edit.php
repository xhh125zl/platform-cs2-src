...
if($_POST){ 
  if($_POST["Isdraw"]==0) {
      if($_POST['T_count']==0) 
      {
        echo '<script language="javascript">alert("允许中奖团数不能为0!");history.back();</script>'; exit();
      }
  }
      ...
      <form id="product_add_form" class="r_con_form skipForm" method="post" action="product_edit.php">
       ...
       <div class="clear"></div>
        ...
        <div class="rows">
          ...
          <input type="text" name="PriceD" value="<?php echo $pintuan["Products_PriceD"]?>" class="form_input" size="5" maxlength="10" readonly/>
          团购价格:￥
          <input type="text" name="PriceT" value="<?php echo $pintuan["Products_PriceT"]?>" class="form_input" size="5" maxlength="10" readonly/>
          </span>
          <div class="clear"></div>
        </div>
        <div class="rows">
        ...
        <div class="rows">
          <label>产品重量</label>
          <span class="input">
          <input type="text" name="Weight" value="<?=$pintuan["Products_Weight"]?>" readonly class="form_input" size="5" />&nbsp;&nbsp;千克
          </span>
          <div class="clear"></div>
        </div>
    <?php
    $image=json_decode($pintuan['Products_JSON'],true);
      ?>
        ...
        <div class="rows">
          <label>简短介绍</label>
          <span class="input">
          <textarea name="BriefDescription" class="briefdesc" readonly/><?php echo $pintuan['Products_BriefDescription']; ?></textarea>
          </span>
          <div class="clear"></div>
        </div>
        ...
        <div class="rows">
          <label>拼团人数</label>
          <span class="input">
          <input type="text" name="Peoplenum" value="<?php echo $pintuan["people_num"]?>" class="form_input" size="5" maxlength="10" readonly/> <span class="tips">&nbsp;注:若不限则填写0.</span>
          </span>
          <div class="clear"></div>
        </div>
        <div class="rows">
