...
$template_dir = $_SERVER["DOCUMENT_ROOT"].'/member/CloudShopping/html';
...
$order =$DB->GetRs("user_order","*","where Users_ID='".$_SESSION["Users_ID"]."' and Order_ID='".$OrderID."'");
...
//购货人信息
$user =$DB->GetRs("user","*","where Users_ID='".$_SESSION["Users_ID"]."' and User_ID='".$User_ID."'");
