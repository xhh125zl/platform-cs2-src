...
$item=$DB->GetRs("zhongchou_project","*","where usersid='".$_SESSION["Users_ID"]."' and itemid=".$itemid);
if(!$item){
...
if($_POST){
	...
	$Flag=$DB->Set("zhongchou_project",$Data,"where usersid='".$_SESSION["Users_ID"]."' and itemid=$itemid");
	if($Flag){
