...
if(isset($_GET["action"])){
	if($_GET["action"]=="del"){
		$Flag=$DB->Del("zhongchou_prize","usersid='".$_SESSION["Users_ID"]."' and prizeid=".$_GET["prizeid"]);
		if($Flag){
  ...
  <div class="iframe_content">
    ...
    <div id="column" class="r_con_wrap"> 
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="mytable">
				...
				<?php
				$DB->get("zhongchou_prize","*","where usersid='".$_SESSION["Users_ID"]."' and projectid=$projectid order by addtime asc");
				$i = 0;
