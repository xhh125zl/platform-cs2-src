...
if(strlen($user['User_Mobile']) == 0 ){
	header("location:/api/".$UsersID."/distribute/bind_mobile/");
}
...
<div class="wrap">
  ...
  <div class="alert alert-info alert-dismissable">
      ...
      &times;
   	...
   	号码更改成功 &nbsp;&nbsp<a href="<?=distribute_url()?>">点击返回主页</a>
	</div>
  
  <?php endif;?>
        	
            <ul class="list-group" id="bind_mobile_panel">
  <form method="post" action="/api/<?=$UsersID?>/distribute/change_bind/"  id="bind_mobile_form">
  ...
  <span class="pull-right">
     <a class="red" href="<?=distribute_url('forget_pwd/')?>">忘记密码</a>
  </span>
