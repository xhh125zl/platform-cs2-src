...
$shaInfo = $DB->GetRs('sha_order', '*', ' where `Users_ID`="' .$UsersID. '" AND `User_ID`="' .$User_ID. '" AND `Order_Status`!=3');
	        ...
	        <td class="l">
	        	<div class="tdContent">
	        		...
	        		<div class="rightContent">
	        			<span class="m">分销商等级：<?php echo !empty($dis_level[$Sha_Rate['sha']['Level']]['Level_Name']) ? $dis_level[$Sha_Rate['sha']['Level']]['Level_Name'] : ''; ?></span>				        					        	
	        			<span class="m">个人消费额：<span class="bold">¥<?php echo !empty($Sha_Rate['sha']['Selfpro']) ? $Sha_Rate['sha']['Selfpro'] : ''; ?></span></span>		        	
	        			<span class="m">团队销售额：<span class="bold">¥<?php echo !empty($Sha_Rate['sha']['Teampro']) ? $Sha_Rate['sha']['Teampro'] : ''; ?></span></span>        		
	        		</div>
	        	</div>
	        	<div class="tdContent">
