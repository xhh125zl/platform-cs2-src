...
//获取所有分销账号列表
$rsAccount = $DB->get('distribute_account','User_ID,invite_id,level,Real_Name',"where Users_ID='".$UsersID."'");
...
<div class="wrap">
    ...
    <ul id="distribute_group">
   		<li class="item cur"><a href="/api/<?=$UsersID?>/distribute/group/?wxref=mp.weixin.qq.com">我的团队</a></li>
   		<li class="item "><a href="/api/<?=$UsersID?>/distribute/my_distribute/?wxref=mp.weixin.qq.com">我的推广</a></li>
   		<li class="item"><a href="/api/<?=$UsersID?>/distribute/income/?wxref=mp.weixin.qq.com">分销佣金</a></li>
