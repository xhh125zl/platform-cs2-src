...
<body>
	<div class="column">
		<h2
			style="text-align: center; height: 37px; line-height: 37px; color: #999;">
	...
	<div id="gift">
		<div class="t_list">
			<a href="/api/<?php echo $UsersID ?>/cloud/member/products/"
				class="c">已领取</a> <a
				href="/api/<?php echo $UsersID ?>/cloud/member/products/no/">未领取</a>
		</div>
  <?php
