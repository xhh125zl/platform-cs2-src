...
<body>
	<link href="/static/api/cloud/css/index.css" rel="stylesheet"
		type="text/css">
	<link
		href='/static/js/plugin/flexslider/flexslider.css?t=<?php echo time();?>'
		rel='stylesheet' type='text/css' />
	<script type='text/javascript'
		src='/static/js/plugin/flexslider/flexslider.js'></script>
	<script type='text/javascript' src='/static/api/shop/js/toast.js'></script>
	<script type='text/javascript'
		src='/static/api/cloud/js/index.js?t=124'></script>
	<script>
...
<div class="banner">
		...
		<?php foreach($slide_list as $key => $val){?>
			<li><a href="<?php echo $val['slide_link'];?>"><img
						src="<?php echo $val['slide_img'];?>"
						alt="<?php echo $val['slide_title'];?>"></a></li>
		<?php }?>
		</ul>
		</div>
	</div>
...
<!--导航-->
	<nav id="goodsNav" class="nav-wrapper">
		<div class="nav-inner">
		    ...
		    <li order="IsRecommend" class="current" style="width: 23%;"><a
					href="javascript:;"><span>推荐</span></a></li>
			...
			<?php }else{ ?>
			<li order="republicTime" class="current" style="width: 23%;"
					method="asc"><a href="javascript:;"><span>时间 ↑↓</span></a></li>
				<li order="sales" style="width: 23%;"  method="asc"><a
					href="javascript:;"><span>销量 ↑↓</span></a></li>
				<li order="prices" style="width: 23%;" method="asc"><a
					href="javascript:;"><span>价格 ↑↓</span></a></li>
				<li order="define" style="width: 31%;" method="asc"><a
					href="javascript:;"><span>综合 ↑↓</span></a></li>
			<?php } ?>
		</ul>
		</div>
		<!--点击添加或移除current-->
		<div id="divSort" class="select-btn">
			<span class="select-icon"> <i></i><i></i><i></i><i></i>
			</span> 分类
		</div>
		<!--分类-->
	...
	<div class="select-total" style="display: none">
			...
			<?php foreach($category_list as $key => $val){?>
				<li><a
					href="<?php echo $cloud_url.'category/'.$val['Category_ID'].'/';?>"><?php echo $val['Category_Name'];?></a></li>
			<?php }?>
		</ul>
		</div>
	<?php }?>
