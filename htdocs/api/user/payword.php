...
<script language="javascript">$(document).ready(user_obj.user_payword_init);</script>
<div id="my">
  <form id="user_form">
    <div class="profile">修改支付密码</div>
    <div class="input">
      <input type="password" name="YPayPassword" value="" placeholder="原始支付密码" notnull />
    </div>
    <div class="input">
      <input type="password" name="PayPassword" value="" placeholder="新支付密码" notnull />
    </div>
	<div class="input">
      <input type="password" name="QPayPassword" value="" placeholder="确认支付密码" notnull />
    </div>
    <div class="submit">
    ...
    <input type="hidden" name="action" value="payword" />
