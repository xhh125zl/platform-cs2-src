<div id="result">
	...
	<div class="result_f">
		<div>酷！用时：<?php echo $rsResult["Score"];?>秒</div>
	</div>
	<ul class="link">
...
<div id="rank">
    ...
    <?php
	$lists = array();
    $DB->get("games_result","*","where Users_ID='".$UsersID."' and Games_ID=".$rsGames["Games_ID"]." and Score>0 order by Score asc");
	...
	?>
		<li<?php if($i%2==1){?> class="f"<?php }?>>
			...
			<div class="wheel">用时<?php echo $v;?>秒</div>
		</li>
	<?php }?>	
	</ul>
</div>