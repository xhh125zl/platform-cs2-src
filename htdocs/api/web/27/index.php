<?php
$Dwidth = array('640','120','120','120','120','120','120','120','120','120');
$DHeight = array('280','120','120','120','120','120','120','120','120','120');
...
var skin_index_init=function(){
	$('#header').hide();//, #footer, #footer_points, #global_support
 ...
 <div id="web_skin_index">
    ...
    <div class="box">
    	<ul>
        	...
        	<li>
                <div class="web_skin_index_list" rel="edit-t010">
                    <div class="img"></div>
                    <div class="text"></div>
                </div>
            </li>
