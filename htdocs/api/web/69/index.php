...
<div id="web_skin_index">
    ...
    <div class="web_wrap">
		...
		?>
		<div class="section b<?php echo $i;?>">
				<a href="<?php echo (empty($r["Column_Link"])?'/api/'.$UsersID.'/web/column/'.$r["Column_ID"].'/':$r["Column_LinkUrl"]);?>">
				<div class="section-left"><img src="<?php echo $r["Column_ImgPath"];?>" /></div>
				<div class="section-right">
					<div class="section-name"><?php echo $r["Column_Name"];?></div>
					<div class="section-desc"><?php echo $r["Column_Description"];?></div>
					<div class="section-icon"><img src="/static/api/web/skin/<?php echo $rsConfig['Skin_ID'];?>/icon.png" /></div>
				</div>
				<div class="clear"></div>
				</a>
		</div>
