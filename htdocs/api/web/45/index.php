<?php
$Dwidth = array('640','50','50','50','345','80','80');
$DHeight = array('260','50','50','50','180','80','80');
  ...
  <div id="web_skin_index">
        ...
        <div class="box">
          <div class="box_content_0">
            <div class="web_skin_index_list l_img_0" rel="edit-t06">
                <div class="img"></div>
                <div class="text"></div>
            </div>
            <div class="web_skin_index_list r_img_0" rel="edit-t07">
              <div class="r_0">
                <div class="img"></div>
                <div class="text"></div>
              </div>
