<?php
$Dwidth = array('640','205','205','205','422','205','205','205','205');
$DHeight = array('384','195','195','195','195','195','173','173','173');
...
<div id="web_skin_index">
          <div class="list">
            ...
            <div class="box">
                ...
                <div class="web_skin_index_list list_0" rel="edit-t05">
                    <div>
                        <div class="img"></div>
                    </div>
                </div>
                ...
                <div class="web_skin_index_list list_1" rel="edit-t07">
                    <div>
                        <div class="img"></div>
                    </div>
                </div>
                <div class="web_skin_index_list list_1" rel="edit-t08">
                    <div>
                        <div class="img"></div>
                    </div>
                </div>
                <div class="web_skin_index_list list_1" rel="edit-t09">
                    <div>
                        <div class="img"></div>
                    </div>
                </div>
...
<script language="javascript">
$(function(){
	$('#header, #footer_points, #footer, #global_support_point, #global_support').hide();
