<?php
$Dwidth = array('640','160','160','160','160','160','160');
$DHeight = array('1010','160','160','160','160','160','160');
...
$(function(){
	...
	$('#web_skin_index .banner *').not('img').height($(document).height());
	var p=320/$(window).width();
	p=p.toFixed(1);
	if((265/p+200)>$('#web_skin_index').height()){
		$('#web_skin_index').height((265/p+200));
	}
	$('.web_contents').css('top',265/p);
})
</script>
    	...
    	<ul>
					...
					<div class="web_skin_index_list item" rel="edit-t07">
						<div class="img"></div>
							...
							<li>
					<div class="web_skin_index_list item" rel="edit-t08">
						<div class="img"></div>
					</div>
				</li>
							<li>
					<div class="web_skin_index_list item" rel="edit-t09">
						<div class="img"></div>
					</div>
				</li>
							<li>
					<div class="web_skin_index_list item" rel="edit-t10">
						<div class="img"></div>
					</div>
				</li>
			        </ul>
