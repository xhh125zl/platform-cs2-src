...
<div id="web_skin_index">
	...
	<div class="web_contents">
        ...
        <?php
		$i=0;
		$bg = array('mar_l45','mar_l24','mar_l7','','mar_l7','mar_l24','mar_l45','mar_l24','mar_l7','','mar_l7','mar_l24','mar_l45','mar_l24');
		$DB->get("web_column","*","where Users_ID='".$UsersID."' and Column_ParentID=0 order by Column_Index asc");
			while($rsColumn=$DB->fetch_assoc()){
				echo '<div class="menu_01 '.$bg[$i].'"><a href="'.(empty($rsColumn["Column_Link"])?'/api/'.$UsersID.'/web/column/'.$rsColumn["Column_ID"].'/':$rsColumn["Column_LinkUrl"]).'">'.$rsColumn["Column_Name"].'</a></div>';
				$i++;
		}?>	
       </div>
	</div>
