<?php
$Dwidth = array('640','156','156','156','156','156');
$DHeight = array('1010','104','104','104','104','104');
...
$(function(){
	...
	$('#web_skin_index .web_contents').height($(window).height());
	$('#web_skin_index .web_contents .item').height(($(window).height())/5);
});
</script>
<div id="web_skin_index">
    ...
    <div class="web_contents">		
        <div class="web_skin_index_list item i1"  rel="edit-t02">
            <div class="img"></div>
            <div class="text"></div>
        </div>
        <div class="web_skin_index_list item i2"  rel="edit-t03">
            <div class="img"></div>
            <div class="text"></div>
        </div>
        <div class="web_skin_index_list item i3"  rel="edit-t04">
            <div class="img"></div>
            <div class="text"></div>
        </div>
        <div class="web_skin_index_list item i4"  rel="edit-t05">
            <div class="img"></div>
            <div class="text"></div>
        </div>
        <div class="web_skin_index_list item i5"  rel="edit-t06">
            <div class="img"></div>
            <div class="text"></div>
        </div>
	</div>
