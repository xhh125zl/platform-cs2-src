...
if(!empty($user['User_Mobile'])){
	header("location:/api/".$UsersID."/shop/distribute/change_bind/");
}
...
<div class="wrap">
  ...
  <div class="alert alert-success alert-dismissable">
      ...
      &times;
   	...
   	恭喜你，绑定成功 &nbsp;&nbsp<a href="<?=shop_url()?>">点击返回主页</a>
	</div>
  
  <?php endif;?>
        	
    <ul class="list-group" id="bind_mobile_panel">
	  <form method="post" action="/api/<?=$UsersID?>/shop/distribute/bind_mobile/"  id="bind_mobile_form">
