...
<div id="iframe_page">
  <div class="iframe_content">
    ...
    <div id="orders" class="r_con_wrap">
      ...
      <div class="control_btn"><a href="payment_add.php" class="btn_green btn_w_120">生成收款单</a></div>
      <table border="0" cellpadding="5" cellspacing="0" class="r_con_table" id="order_list">
        ...
        <tbody>
         ...
         <tr>
            ...
            <td nowrap="nowrap">
            	<a href="?action=getpay&paymentid=<?php echo $paymentid;?>">[确定收款]</a>&nbsp;<a href="payment_detail.php?paymentid=<?php echo $paymentid;?>">[查看详情]</a>
