...
$rsOrder=$DB->GetRs("user_order","*","where Users_ID='".$rsBiz["Users_ID"]."' and Order_ID='".$OrderID."' and Biz_ID=".$_SESSION["BIZ_ID"]);
if($_POST){
	$Data=array(
		"Order_Status"=>1
	);
	$Flag=$DB->Set("user_order",$Data,"where Users_ID='".$rsBiz["Users_ID"]."' and Order_ID=".$OrderID);
	if($Flag){
...
if($rsOrder["Is_Backup"]==1){
	$condition = "where Users_ID='".$rsBiz["Users_ID"]."' and Order_ID=".$OrderID." and Back_Type='shop'";
