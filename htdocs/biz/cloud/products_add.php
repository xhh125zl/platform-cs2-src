		...
		<div id="products" class="r_con_wrap">
			...
			<form id="product_add_form" class="r_con_form" method="post" action="products_add.php">
				...
				<div class="rows">
					<label>排序</label>
					<span class="input">
					<input type="text" name="Order" value="0" class="form_input" size="10" maxlength="100" />
					</span>
					<div class="clear"></div>
				</div>
				<div class="rows">
				...
				<div class="rows">
					...
					<input type="text" name="xiangoutimes" value="0" class="form_input" size="5" maxlength="10" />
					<span>(0或空表示不限制)</span>
					</span>
					<div class="clear"></div>
				</div>
				<div class="rows" style="display:none;">
					...
					<input type="text" name="Products_Profit" value="" class="form_input" size="5" maxlength="10"/>
				...
				<div class="rows" style="display:none;">
					<label>佣金比例</label>
					<span class="input price"> <span>%</span>
					<input type="text" name="commission_ratio" value="100" class="form_input" size="5" maxlength="10" notnull />
					<span>(佣金所占利润百分比，利润分为佣金和爵位奖励两部分)</span> </span>
					<div class="clear"></div>
				</div>
				<div class="rows" style="display:none;">
					<label>佣金返利</label>
					...
					for($i=0;$i<$level;$i++){?>
						<tr>
							<td><?php echo $arr[$i]?>级&nbsp;&nbsp;%
								<input name="Distribute[<?php echo $i;?>]" value="" class="form_input" size="5" maxlength="10" type="text">
								(佣金利润的百分比) </td>
						</tr>
						<?php }?>
					</table>
				...
				<div class="rows">
					<label>产品重量</label>
					<span class="input">
					<input type="text" name="Products_Weight" value="" notnull class="form_input" size="5" />
					&nbsp;&nbsp;千克 </span>
					<div class="clear"></div>
				</div>
				<div class="rows">
					...
					免运费&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;
					<input type="radio"   value="0"   name="Products_IsShippingFree" checked />
					物流模板
					<?php else: ?>
					&nbsp;&nbsp;
					<input type="radio" value="1" checked="checked"name="Products_IsShippingFree"  checked />
					免运费&nbsp;&nbsp;&nbsp;&nbsp;
					没有可用的物流模板
					<?php endif;?>
					</span>
				...
				<div class="rows">
					...
					<input type="checkbox" value="1" name="SoldOut" /></label>
					&nbsp;|&nbsp;
					<label>新品:
					<input type="checkbox" value="1" name="IsNew" /></label>
					&nbsp;|&nbsp;
					<label>热卖:
					<input type="checkbox" value="1" name="IsHot" /></label>
					&nbsp;|&nbsp;
					<label>推荐:
					<input type="checkbox" value="1" name="IsRecommend" /></label>
					&nbsp;|&nbsp;
					<label style="display:none;">虚拟产品(电子券消费形式):
					<input type="checkbox" value="1" name="IsVirtual" /></label>
					&nbsp;|&nbsp;
					<label style="display:none;">虚拟产品(订单付款后即刻完成):
					<input type="checkbox" value="1" name="IsRecieve" /></label>
					</span>
					<div class="clear"></div>
				</div>
				<div class="rows">
