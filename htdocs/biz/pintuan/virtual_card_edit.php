...
$rsCart = $DB->GetRs("pintuan_virtual_card","*","where User_Id='".$_SESSION["Users_ID"]."' and Card_Id=".$CardId);
...
if ($_POST) {
	...
	$Flag = $DB->set('pintuan_virtual_card', $Data, "where User_ID='".$_SESSION["Users_ID"]."' and Card_Id=".$CardId);
	if($Flag)
	{
