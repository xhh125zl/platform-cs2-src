...
var shipping_obj = {
	 shop_shiping_init:function(){
        ...
        $(".shipping_edit_btn").click(function() {
            ...
            $.get(base_url + 'biz/ajax.php', param, function(data) {
                if (data.status == 1) {
	...
	printtemplate_init:function(){
		$('#printtemplate_form').submit(function(){
			if(global_obj.check_form($('*[notnull]'))){return false};
			$('#printtemplate_form input:submit').attr('disabled', true);
			return true;
		});
	},
}
