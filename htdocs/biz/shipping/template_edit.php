...
if($_POST){
	$Data = handle_template_post_data($Users_ID,$_SESSION["BIZ_ID"],$_POST);
	...
	$condition = "where Users_ID='".$Users_ID."' and Template_ID=".$Template_ID;

	$flag=$DB->Set("shop_shipping_template",$Data,$condition);
	
	if($flag){
		echo '<script language="javascript">alert("编辑成功！");window.open("template.php","_self");</script>';
		exit();
	}else{
...
//获取可用快递公司列表
$Shipping_Compny_List = get_shipping_company($Users_ID,1,$_SESSION["BIZ_ID"]);
           	...
           	<div class="rows deliver_content_container">
                ...
                <div class="input">
                    ...
                    <div id="deliver_content">
                        	...
                        	<?=build_shipping_section_html($smarty,$Users_ID,$rsTemplate['Shipping_ID'],$rsTemplate['By_Method'],$rsTemplate['Template_Content'])?>
