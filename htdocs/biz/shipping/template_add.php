...
if($_POST){
	...
	if($flag){
		echo '<script language="javascript">alert("添加成功！");window.open("template.php","_self");</script>';
		exit();
	}else{
                ...
                <div class="input">
                    ...
                    <div id="deliver_content">
               	    	<?php if($default_shipping_company != 0):?>
                        	<?=build_shipping_section_html($smarty,$Users_ID,$default_shipping_company,$default_by_method)?>
						<?php else:?>
                           还未添加快递公司,请去添加快递公司
						<?php endif;?>
                    </div>
