...
$condition = "WHERE `User_ID` = '".$rsBiz["Users_ID"]."'";
  ...
  <div class="iframe_content">
    ...
    <div id="products" class="r_con_wrap"> 
      ...
      <table width="100%" align="center" border="0" cellpadding="5" cellspacing="0" class="r_con_table">
        ...
        <?php
        	$List = Array();
        	$DB->getPage("shop_virtual_card","*",$condition,10);
        ...
        ?>
          <tr>
            ...
            <td nowrap="nowrap"><?php 
              if (!empty($v['Type_Id'])) {
                $type = $DB->GetRs('shop_virtual_card_type', 'Type_Name', 'WHERE Type_Id='.$v['Type_Id']);
                echo $type['Type_Name'];
              }
            ?></td>
            <td nowrap="nowrap" width="25%" style="text-align:left; padding-left:10px;"><?php 
            	if(empty($v['Products_Relation_ID'])){ 
            		...
            		$One = $DB->GetRs('shop_products', 'Products_Name', 'WHERE Products_ID='.$v['Products_Relation_ID']);
            		echo !empty($One) ? $One['Products_Name'] : '<span class="red">'.NO_RELATION_PRODUCTS_STATUS.'</span>';
            	} ?>
            </td>
