...
<div id="iframe_page">
  <div class="iframe_content">
    ...
    <div class="r_nav">
      <ul>
        <li><a href="shop_attr.php">产品属性库</a></li>
	...
	<script language="javascript">
      ...
      <div class="attr">
        <div class="m_righter" style="margin-left:0px;">
          ...
          <label>可选值：</label>
          <span class="input">
          	<textarea name="Attr_Values" id="Attr_Values" disabled="true" notnull></textarea>
          </span>
          <br/>
          ...
          每行一个属性值
            ...
            <div class="opt_item">
              <label></label>
              <span class="input">
              <input type="submit" class="btn_green btn_w_120" name="submit_button" value="添加属性" /></span>
              <div class="clear"></div>
            </div>
          </form>
        </div>
