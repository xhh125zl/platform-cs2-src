		...
		<div class="iframe_content">
			<div id="products" class="r_con_wrap" style="padding-bottom: 60px;">
				<form id="product_add_form" class="r_con_form skipForm"
					...
					<input type="hidden" name="Indexlist"
						value="<?=$rsActive['IndexConfig'] ?>" />
					<div class="rows">
					...
					<div class="rows">
						<label>推荐到首页的产品</label> <span class="input">
							<div class="box1 col-md-6" style="width: 500px;">
								<a href="#" class="btn_green" id="selectIndex"
									style="float: right; margin-right: 20px;">选择产品</a> <select
									multiple="multiple"
									id="bootstrap-duallistbox-nonselected-list_commit"
									class="form-control" name="Indexcommit"
									style="height: 100px; width: 300px;">
                            <?php
                            if (! empty($rsActive['IndexConfig']) && $rsActive['IndexConfig']) {
                                ...
                                if (! empty($indexList)) {
                                    foreach ($indexList as $v) {
                                        ?>
                            <option
										value="<?=isset($goods[$v]['Products_ID'])?$goods[$v]['Products_ID']:'' ?>"><?=isset($goods[$v]['Products_Name'])?$goods[$v]['Products_Name']:'' ?> </option>
                            <?php
                                    }
                                }
                            }
